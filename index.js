    ...
    <WagmiConfig config={wagmiConfig}>
      <div style={{ backgroundColor: '#050505', minHeight: '100vh', color: 'white', fontFamily: 'sans-serif' }}>
        ...
        <main style={{ textAlign: 'center', marginTop: '100px' }}>
          ...
          <button 
            onClick={() => document.querySelector('w3m-button').shadowRoot.querySelector('button').click()}
            style={{ padding: '15px 40px', backgroundColor: '#9333ea', color: 'white', borderRadius: '10px', fontWeight: 'bold', border: 'none', cursor: 'pointer', fontSize: '18px' }}
          > 
            BUY USDX 
          </button>
        </main>
